...
public sealed class MatchServiceTests
{
        ...
        bool osaeKomiYukoEnabled = true)
    {
        ...
        ctx.Tournaments.Add(new ShiaiManager.Api.Data.TournamentRecord
        {
            Id = tid,
            Name = "Test",
        ...
        ctx.Categories.Add(new ShiaiManager.Api.Data.CategoryRecord
        {
            Id = cid,
            TournamentId = tid,
            Name = "U18 M -73",
        ...
        ctx.Fights.Add(new ShiaiManager.Api.Data.FightRecord
        {
            Id = fid,
            TournamentId = tid,
            CategoryId = cid,
